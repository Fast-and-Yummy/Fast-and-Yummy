...
import NameChecker from './Admin/NameChecker';
  ...
  <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    <div className="relative flex h-16 items-center justify-between">
      ...
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div className="hidden sm:ml-6 sm:block">
          <div className="flex space-x-4">
            ...
            <a href="#" className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Pages</a>
      ...
      <div className="  mb-1 mr-32">
        <button onClick={()=>{navigate("/Shop")}} type="button" className="rounded-full  bg-gray-800  text-gray-400 hover:text-white outline-none px-2 focus:ring-2 ring-white ring-offset-2 focus:ring-offset-gray-800">
      ...
      <div className="  mr-20">
        ...
        <p className='ml-2   text-red-800 bold font-bold '>{count}</p>
  ...
  <div className="sm:hidden" id="mobile-menu">
    <div className="space-y-1 px-2 pb-3 pt-2">
      ...
      <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Order online</a>

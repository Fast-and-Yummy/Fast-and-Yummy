...
function Favmain() {
    return (
        <div  className='bg-gray-100 pt-1 pb-10     '>
            <div className=' mt-14 '>
        <p className='  text-yellow-300 font-semibold text-center'>WHAT WE SERVE </p>
            <p className=' font-serif text-4xl font-bold text-center '>Your Favourite Food <br></br> Delivery Partner</p>
            </div> 

...
<div class="min-h-80   aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
  <img src={e.img} alt="Front of men&#039;s Basic Tee in black." class="h-full w-full object-cover object-center lg:h-full lg:w-full" />
</div>
<div class="mt-4 flex justify-between">
  ...
  <div>
    ...
    <span className='text-center mt-10 ml-3 absolute left-20 border-solid border-2 px-3 py-1 rounded-md  bg-yellow-500/100 text-white'>Add to card</span>
  </div>
</div>
</div>
            ))}
